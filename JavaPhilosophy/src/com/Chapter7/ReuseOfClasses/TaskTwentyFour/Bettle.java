package com.Chapter7.ReuseOfClasses.TaskTwentyFour;
...
class Fly extends Bettle {
    private int k = printInit("Поле Fly.k инициализировано");
    Fly() {
        System.out.println("k = " + k);
        System.out.println("j = " + j);
    }
    private static int x2 = printInit("Поле static Fly.x2 инициализировано");
